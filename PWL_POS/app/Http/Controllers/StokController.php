...
class StokController extends Controller
{
    ...
    {
        $stok = StokModel::select('stok_id', 'supplier_id', 'user_id', 'barang_id', 'stok_tanggal', 'stok_jumlah')
            ->with('supplier')
            ->with('user')
            ->with('barang');
        ...
        return DataTables::of($stok)
            ...
            ->addColumn('aksi', function ($stok) { // menambahkan kolom aksi
                ...
                $btn .= '<button onclick="modalAction(\'' . url('/stok/' . $stok
                    ->stok_id . '/edit_ajax') . '\')" class="btn btn-warning btn-sm">Edit</button> ';
                $btn .= '<button onclick="modalAction(\'' . url('/stok/' . $stok
                    ->stok_id . '/delete_ajax') . '\')" class="btn btn-danger btn-sm">Hapus</button> ';
                return $btn;
            })
    ...
    public function create_ajax()
    {
        ...
        $user = UserModel::select('user_id', 'nama')->get();
        $barang = BarangModel::select('barang_id', 'barang_nama')->get();
        return view('stok.create_ajax')->with(['supplier' => $supplier, 'user' => $user, 'barang' => $barang]);
    }
    ...
    public function show_ajax(string $id)
    {
        ...
        return view('stok.show_ajax')->with(['stok' => $stok, 'barang' => $barang, 'supplier' => $supplier, 'user' => $user]);
    }
    ...
    public function edit_ajax(string $id)
    {
        ...
        $user = UserModel::select('user_id', 'nama')->get();
        $barang = BarangModel::select('barang_id', 'barang_nama')->get();
        return view('stok.edit_ajax')->with(['stok' => $stok, 'barang' => $barang, 'supplier' => $supplier, 'user' => $user]);
    }
    ...
    public function export_excel()
    {
        ...
        $stok = StokModel::select('supplier_id', 'user_id', 'barang_id', 'stok_tanggal', 'stok_jumlah')
            ->orderBy('barang_id')
            ->with('supplier')
            ->with('user')
            ->with('barang')
